-- @name: combat_micro_closest_tight_retreat
-- @events: on_tick
-- @interval: 3

-- Gen 40: Gen 34 (closest-enemy focus, 16/20) + Gen 33 tighter retreat (20% HP).
-- Gen 33 showed some faster wins with 20% retreat vs 30%. Combining with
-- Gen 34's closest-enemy focus to see if both improvements stack.
...
-- === RETREAT at 20% HP (tighter than 30%) ===
local retreat_ids = {}
for _, u in ipairs(combat_units) do
