-- @name: combat_micro_cover_retreat
-- @events: on_tick
-- @interval: 3

-- Gen 44: Gen 42 base (terrain-aware kiting) + cover-seeking retreat (2c).
-- Hypothesis: Retreating to cover instead of nearest building absorbs more
-- damage and preserves wounded units. No elevation features.
-- Budget: ~42/500 (8%) — kiting ~15 + safe_positions+cover_at ~27.
...
-- === FOCUS FIRE: closest enemy to centroid (same as Gen 34) ===
