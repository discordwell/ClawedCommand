-- @name: combat_micro_v4
-- @events: on_tick
-- @interval: 3

-- Gen 26: Best of Gen 24 (kiting) + aggressive push to convert timeouts.
-- Changes from Gen 24:
-- 1. Keep kiting for ranged units (preserves army, proven in Gen 24)
-- 2. Push when strong army advantage (>= enemy+3), not just when 0 enemies
-- 3. Push targets HQ specifically
-- 4. Only kite when outnumbered (don't kite when we have advantage)
...
-- Push when: no enemies visible (area clear), OR strong army advantage
