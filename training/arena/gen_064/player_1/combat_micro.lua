-- @name: combat_micro_triple_combo
-- @events: on_tick
-- @interval: 3

-- Gen 64: Gen 060 (timed push) + Gen 059 (HP kite) + Gen 053 (inline formation).
-- Kitchen sink: all three best individual improvements combined.
-- Timed push converts timeouts, HP kite protects ranged, formation positions idle units.
...
-- === INLINE FORMATION (from Gen 053) — only pre-late-game ===
...
-- === HP-THRESHOLD KITING (from Gen 059) — disabled in late game ===
