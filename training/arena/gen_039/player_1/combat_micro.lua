-- @name: combat_micro_closest_push2
-- @events: on_tick
-- @interval: 3

-- Gen 39: Gen 34 (closest-enemy focus) + push at >=2 advantage (Gen 37).
-- Gen 34 is best at 16/20. Gen 37 had 14 wins but fewer P0 wins (1 vs 2).
-- Combining: closest-enemy targeting + lower push threshold for more
-- building pressure with a moderate advantage.
