-- @name: combat_micro_aggro_push
-- @events: on_tick
-- @interval: 3

-- Gen 46: Gen 42 base + aggressive push threshold.
-- Lower push threshold from +3 to +1 advantage. Push earlier to convert
-- timeouts into decisive wins. Keep terrain-aware kiting.
-- Budget: ~15/500 (3%).
...
-- CHANGED: push at +1 advantage instead of +3
local strong_advantage = my_combat_count >= enemy_count + 1
...
-- CHANGED: triggers at +1 advantage instead of +3
