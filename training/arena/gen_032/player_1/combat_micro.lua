...
-- Gen 32: Gen 30 + more aggressive push trigger.
-- Push at ANY army advantage (>=1 more), not just >=3.
-- Production building targeting from Gen 30 (barracks/tech first).
...
local any_advantage = my_combat_count > enemy_count
