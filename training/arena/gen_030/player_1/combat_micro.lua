-- @name: combat_micro_prod_snipe
-- @events: on_tick
-- @interval: 3

-- Gen 30: Gen 26 base + production building snipe.
-- When pushing, target production buildings (barracks/tech) FIRST to cut
-- enemy reinforcements, THEN HQ. This should convert P1-leading timeouts
-- to decisive wins by starving the enemy of replacement units.
...
if should_push then
    ...
    if enemy_buildings and #enemy_buildings > 0 then
        -- Priority: 1) production buildings (barracks/tech), 2) HQ, 3) nearest
        ...
        for _, b in ipairs(enemy_buildings) do
            ...
            -- Production buildings (barracks, tech labs)
