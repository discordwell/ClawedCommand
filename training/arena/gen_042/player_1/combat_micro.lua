-- @name: combat_micro_terrain_kite_only
-- @events: on_tick
-- @interval: 3

-- Gen 42: Gen 34 base + ONLY terrain-aware kiting (2a).
-- Control variant to isolate kiting improvement vs full terrain package (Gen 41).
-- Budget: ~15/500 (3%).
...
-- === TERRAIN-AWARE KITING (2a — only terrain addition) ===
...
-- === PUSH: target production buildings first, then HQ (same as Gen 34) ===
