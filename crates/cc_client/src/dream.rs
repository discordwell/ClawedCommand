...
fn prop_sprite_path(action: OfficeAction) -> Option<&'static str> {
    match action {
        ...
        OfficeAction::CallAda => Some("sprites/dream/phone.png"),
        OfficeAction::Sleep => Some("sprites/dream/bed_bunk.png"),
        OfficeAction::Eat => Some("sprites/dream/food_tray.png"),
        OfficeAction::Talk => Some("sprites/dream/couch.png"),
        OfficeAction::LeaveBase => Some("sprites/dream/exit_gate.png"),
        OfficeAction::Storage => Some("sprites/dream/ammo_crate.png"),
        OfficeAction::BulletinBoard => Some("sprites/dream/bulletin_board.png"),
        OfficeAction::WaterFountain => Some("sprites/dream/water_fountain.png"),
        OfficeAction::Window => Some("sprites/dream/window_view.png"),
        OfficeAction::BriefingRoom => Some("sprites/dream/briefing_map.png"),
        OfficeAction::CoOffice => Some("sprites/dream/office_door.png"),
        OfficeAction::MedicalBay => Some("sprites/dream/medical_cabinet.png"),
        OfficeAction::LockerRoom => Some("sprites/dream/locker.png"),
        OfficeAction::Courtyard => Some("sprites/dream/flagpole.png"),
        OfficeAction::GuardPost => Some("sprites/dream/exit_gate.png"),
        OfficeAction::Tv => Some("sprites/dream/tv_set.png"),
        OfficeAction::PhotoWall => Some("sprites/dream/photo_frame.png"),
        OfficeAction::CoffeeMachine => Some("sprites/dream/coffee_machine.png"),
        OfficeAction::SitOnBench => Some("sprites/dream/bench_outdoor.png"),
        OfficeAction::CheckVehicles => Some("sprites/dream/humvee.png"),
        OfficeAction::LookAtHelicopter => Some("sprites/dream/helicopter.png"),
        OfficeAction::EnterScif => Some("sprites/dream/scif_door.png"),
        OfficeAction::CheckServers => Some("sprites/dream/server_rack.png"),
        OfficeAction::UseMicrowave => Some("sprites/dream/microwave.png"),
        OfficeAction::GrabSupplies => Some("sprites/dream/supply_shelf.png"),
        OfficeAction::SitAndReflect => Some("sprites/dream/chapel_pew.png"),
        OfficeAction::PlayPool => Some("sprites/dream/pool_table.png"),
        OfficeAction::PlayArcade => Some("sprites/dream/arcade_cabinet.png"),
        OfficeAction::DoLaundry => Some("sprites/dream/washing_machine.png"),
        OfficeAction::ReadMenuBoard => Some("sprites/dream/menu_board.png"),
        OfficeAction::SitWithOthers => Some("sprites/dream/mess_table.png"),
        OfficeAction::ReadLetter => Some("sprites/dream/letter_envelope.png"),
        OfficeAction::GoForRun => Some("sprites/dream/running_track.png"),
    }
}
