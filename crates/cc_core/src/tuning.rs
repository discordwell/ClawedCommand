...
/// LaserPointer (catGPT) tower damage. ~20 DPS (was 6.67).
pub const TOWER_DAMAGE_LASER_POINTER: Fixed = Fixed::from_bits(20 << 16);
...
pub const TOWER_ATTACK_SPEED_LASER_POINTER: u32 = 10;

/// SporeTower (Croak) tower damage. ~16 DPS (was 5.33).
pub const TOWER_DAMAGE_SPORE_TOWER: Fixed = Fixed::from_bits(16 << 16);
...
pub const TOWER_ATTACK_SPEED_SPORE_TOWER: u32 = 10;

/// TetanusTower (LLAMA) tower damage. ~20 DPS (was 6.67).
pub const TOWER_DAMAGE_TETANUS_TOWER: Fixed = Fixed::from_bits(16 << 16);
...
pub const TOWER_ATTACK_SPEED_TETANUS_TOWER: u32 = 8;

/// Watchtower (Murder) tower damage. ~20 DPS (was 6.67).
pub const TOWER_DAMAGE_WATCHTOWER: Fixed = Fixed::from_bits(20 << 16);
...
pub const TOWER_ATTACK_SPEED_WATCHTOWER: u32 = 10;

/// SqueakTower (Clawed) tower damage. ~16 DPS (was 5.33).
pub const TOWER_DAMAGE_SQUEAK_TOWER: Fixed = Fixed::from_bits(16 << 16);
...
pub const TOWER_ATTACK_SPEED_SQUEAK_TOWER: u32 = 10;

/// SlagThrower (Seekers) tower damage. ~16.7 DPS (was 5.0).
pub const TOWER_DAMAGE_SLAG_THROWER: Fixed = Fixed::from_bits(25 << 16);
...
pub const TOWER_ATTACK_SPEED_SLAG_THROWER: u32 = 15;
